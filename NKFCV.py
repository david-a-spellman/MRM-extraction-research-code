...
path = "/mnt/c/data/ComparisonWithCL_PubMedBERTLarge/"
...
#k = 5
#metric_files = ["/mnt/c/data/ComparisonWithoutCL_PubMedBertLarge/5-fold_metrics/fold_1_metrics.json", "/mnt/c/data/ComparisonWithoutCL_PubMedBertLarge/5-fold_metrics/fold_2_metrics.json", "/mnt/c/data/ComparisonWithoutCL_PubMedBertLarge/5-fold_metrics/fold_3_metrics.json", "/mnt/c/data/ComparisonWithoutCL_PubMedBertLarge/5-fold_metrics/fold_4_metrics.json", "/mnt/c/data/ComparisonWithoutCL_PubMedBertLarge/5-fold_metrics/fold_5_metrics.json"]
