# script to produce incorrect predictions by argument for post processed data
import json
...
file_list = ["C:\\Users\\David\\Projects\\Title-Based-Molecular-Regulation-Event-Extraction\\data\\no_arg4\\5-fold_predictions\\PostProcessedPredictions.jsonl"]
...
for key in csv_strings:
	...
	file_name = str ("C:\\Users\\David\\Projects\\Title-Based-Molecular-Regulation-Event-Extraction\\data\\no_arg4\\5-fold_predictions\\" + key + "post_processed.csv")
