...
experiment_set = "ComparisonWithCL_"
bert_model = "PubMedBERTLarge"
path = str ("C:\\data\\" + experiment_set + bert_model + "\\5-fold_predictions\\")
f5_list = list ()
for i in range (1, 6):
...
path = "C:\\data\\" + experiment_set + bert_model + "\\CK_experimental_summary\\"
...
path = str ("C:\\data\\" + experiment_set + bert_model + "\\5-fold_ROC_plots\\")
if not os.path.isdir (path):
	os.mkdir (path)
for key in roc_5f:
