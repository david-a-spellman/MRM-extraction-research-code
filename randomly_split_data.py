...
# Write to files
file_name = "C:\\data\\test_DIGGIE++_input_titles_holdout_100.json"
with open (file_name, 'w') as writing:
	writing.writelines (test_string_list)

file_name = "C:\\data\\dev_DIGGIE++_input_titles_holdout_100.json"
with open (file_name, 'w') as writing:
	writing.writelines (dev_string_list)

file_name = "C:\\data\\train_DIGGIE++_input_titles_holdout_100.json"
with open (file_name, 'w') as writing:
