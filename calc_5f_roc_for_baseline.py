...
experiment = "no_arg4"
path = str ("C:\\data\\" + experiment + "\\")
f5_list = list ()
for i in range (1, 6):
	f5_list.append (str (path + "5-fold_predictions\\" + "fold_" + str (i) + "_predictions.jsonl"))
...
f5_dir = str ("C:\\data\\" + experiment + "\\5-fold_performance_summary\\")
...
path = "C:\\data\\" + experiment + "\\CK_experimental_summary\\"
if not os.path.isdir (path):
		os.mkdir (path)
file_name = str (path + "AUC_report" + "SciBert" + ".txt")
output = list ()
...
file_name = str (path + "metrics_report" + "SciBert" + ".txt")
output = list ()
precisions = dict ()
recalls = dict ()
f1s = dict ()
...
path = str ("C:\\data\\" + experiment + "\\5-fold_ROC_plots\\")
if not os.path.isdir (path):
	os.mkdir (path)
for key in roc_5f:
